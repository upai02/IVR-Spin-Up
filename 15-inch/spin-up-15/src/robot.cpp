...
pros::Motor left_back_top_mtr(12, pros::E_MOTOR_GEARSET_06, false);
pros::Motor left_back_bot_mtr(13, pros::E_MOTOR_GEARSET_06, true);

pros::Motor right_front_mtr(20, pros::E_MOTOR_GEARSET_06, false);
pros::Motor right_back_top_mtr(19, pros::E_MOTOR_GEARSET_06, true);
pros::Motor right_back_bot_mtr(18, pros::E_MOTOR_GEARSET_06, false);
...
pros::ADIEncoder horizontal_track(1, 2, false); // tracking wheel #2
