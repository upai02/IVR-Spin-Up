...
pros::Motor left_front_top_mtr(11, pros::E_MOTOR_GEARSET_06, false);
pros::Motor left_front_bottom_mtr(10, pros::E_MOTOR_GEARSET_06, true);
pros::Motor left_back_mtr(13, pros::E_MOTOR_GEARSET_06, false);
pros::Motor right_front_top_mtr(18, pros::E_MOTOR_GEARSET_06, true);
pros::Motor right_front_bottom_mtr(1, pros::E_MOTOR_GEARSET_06, false);
pros::Motor right_back_mtr(20, pros::E_MOTOR_GEARSET_06, false);

pros::Motor_Group left_side({left_front_top_mtr, left_back_mtr});
pros::Motor_Group right_side({right_front_top_mtr, right_back_mtr});
...
FILE* usd_file_write = fopen("/usd/encoder_positions.csv", "w");